                ...
                ? (
                    <Card style={{ maxWidth: '50rem' }} className='mx-auto'>
                        ...
                        <Card.Footer className='small text-uppercase'>
                            ...
                            <Link to={`/Eliminar/${pelicula.peliculaId}`} className='card-link text-decoration-none'>Editar</Link>
                        </Card.Footer>
                    </Card>
                ) :
                (
                    <Card style={{ maxWidth: '20rem' }} className='mx-auto h-100'>
                        ...
                        <Card.Body>
                            <Card.Title>{pelicula.titulo}</Card.Title>
                            <Card.Subtitle className='mb-2small text-body-secondary'>PELICULA</Card.Subtitle>
                        </Card.Body>
